...
const Component = (props) => {
	...
	const collectionsProps = {
			...
			addCollectionsList(index,listIndex,icon,type) {
				props.dispatch({
				...
				<div>
					...
					<div className="collection-structure">
						...
						{props.vdCollections.listTypeIsOpend ? <div className="collection-structure-list">
							...
							<Row>
								<Col className="collection-structure-list-btn" onClick={collectionsProps.addCollectionsList.bind(this,index,listIndex,'file-text','text')} span={6}>
								...
								<Col className="collection-structure-list-btn" span={6}>
									<div className="collection-btn-content">
										<div className="collection-btn-img">
