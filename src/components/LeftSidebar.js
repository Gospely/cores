...
const leftSidebar = (props) => {
	...
	return (
	  	<Tabs tabPosition="left" defaultActiveKey={props.devpanel.devType.defaultActiveKey} activeKey={props.sidebar.activeMenu} onChange={handleTabChanged}>
	    	<TabPane style={styles.tab} tab={<span style={styles.span} hidden={props.devpanel.devType.visual != 'true'}><Icon style={styles.icon} type="bars" />结构</span>} key="controllers">
