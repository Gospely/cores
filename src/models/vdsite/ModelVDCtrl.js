...
export default {
   ...
   state: {
       ...
       specialAttrList: ['custom-attr', 'link-setting', 'list-setting', 'heading-type', 'image-setting', 'select-setting', 'tabs-setting', 'navbar-setting', 'dropdown-setting', 'slider-setting', 'columns-setting', 'icon-setting'],
       commonAttrList: [],
       symbols: [],
       currentSymbolKey: '',
       symbolName: '',
                                   ...
                                   children: [{
                                       ...
                                       attrs: [{
                                           ...
                                           children: [{
                                               ...
                                               desc: '加一个',
                                               level: 6,
                                               levelsInfo: [{level: 1, index: 1}, {level: 3, index: 2}, {level:4 , index: 1}],
                                               type: 'buttonAdd',
                                               id: '',
                                           },{
                                               name: 'buttonDelete',
